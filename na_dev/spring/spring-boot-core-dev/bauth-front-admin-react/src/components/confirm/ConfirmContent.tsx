...
import { confirm, btnAlt } from "@components/popupStyle";
  ...
  return (
    ...
    >
      <Box sx={confirm}>
        ...
        <Stack sx={btnAlt}>
            <Button variant="outlined" onClick={props.onCancel}>{props.noText}</Button>
            <Button variant="contained" onClick={props.onConfirm}>{props.yesText}</Button>
        </Stack>
      </Box>
    </Modal>
