...
const ReactGridLayoutAddRemove2 = () => {
  ...
  const viewGridLayoutChartChange = (e:React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    /* let test = [
      {key : "a",   dataGrid : { i: "a", w: 12, h: 1, x: 0, y: 0, static: true},                          chartType : ""},
      {key : "b",   dataGrid : { i: "b", w: 6, h: 8, x: 0, y: 1, minW: 6, minH: 6},                       chartType : "map"},
      {key : "c",   dataGrid : { i: "c", w: 1, h: 2, x: 12, y: 1,},                                       chartType : ""},
      {key : "d",   dataGrid : { i: "d", w: 9, h: 13, x: 12, y: 1, minW: 9, maxW: 9, minH: 13, maxH: 13}, chartType : "map"}
    ] */
    //setChartViewConfig([...test]);
  }
...
export default ReactGridLayoutAddRemove2;
