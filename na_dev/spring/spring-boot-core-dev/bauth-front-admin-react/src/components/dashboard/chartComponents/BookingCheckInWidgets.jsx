...
export default function BookingCheckInWidgets({ chart, ...other }) {
  ...
  const chartOptionsGoogle = useChart({
    chart: {
      sparkline: {
        enabled: true,
      },
  ...
  const chartOptionsNaver = {
    ...chartOptionsGoogle,
    colors: [theme.palette.primary.main],
  };

  const chartOptionsKakao = {
    ...chartOptionsGoogle,
  ...
  const chartOptionsArray = [chartOptionsGoogle, chartOptionsNaver, chartOptionsKakao, chartOptionsEmail];
