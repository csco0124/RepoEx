...
import com.narui.democlientb.security.handler.CustomAccessDeniedHandler;
import com.narui.democlientb.security.handler.CustomAuthenticationEntryPoint;
import com.narui.democlientb.security.handler.CustomAuthenticationFailHandler;
import com.narui.democlientb.security.handler.CustomAuthorizationRequestResolver;
import com.narui.democlientb.security.handler.CustomLogoutSuccessHandler;
import com.narui.democlientb.security.handler.OAuth2AuthenticationSuccessHandler;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(expressionInterceptUrlRegistry -> {
            ...
            .mvcMatchers("/private/view/defaultAuth/admin/**", "/api/**", "/test/**").hasRole("ADMIN")
            .mvcMatchers("/private/view/defaultAuth/user/**","/private/view/home", "/api/**", "/test/**").hasRole("USER")
            .mvcMatchers("/private/**", "/api/**", "/test/**").hasRole(clientAuthority)
//            .mvcMatchers("/**").permitAll()
        ...
        http.oauth2Login(httpSecurityOAuth2LoginConfigurer -> {
            ...
            httpSecurityOAuth2LoginConfigurer.defaultSuccessUrl(defaultSuccessUrl);
            httpSecurityOAuth2LoginConfigurer.authorizationEndpoint().authorizationRequestResolver(authorizationRequestResolver());
