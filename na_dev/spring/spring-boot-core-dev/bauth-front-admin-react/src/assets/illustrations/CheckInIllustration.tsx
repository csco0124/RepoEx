...
function CheckInIllustration({ ...other }) {
  ...
  const PRIMARY_LIGHTER = theme.palette.primary.light;//theme.palette.primary.lighter;
  ...
  const PRIMARY_DARKER = theme.palette.primary.dark;//theme.palette.primary.darker;
