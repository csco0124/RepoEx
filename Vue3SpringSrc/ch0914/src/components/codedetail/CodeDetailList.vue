  ...
  <div>
    <table border="1">
      ...
      <tr v-else v-for="codeDetail in codeDetails" :key="`${codeDetail.groupCode}-${codeDetail.codeValue}`">
        ...
        <td align="left"><router-link :to="{ name: 'CodeDetailReadView', params: { groupCode: codeDetail.groupCode, codeValue: codeDetail.codeValue } }">{{ codeDetail.codeName }}</router-link></td>
