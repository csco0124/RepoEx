...
import { deafaultGridThemeSettings } from './config-grid';
...
export function SettingsProvider({ children }) {
  ...
  const [gridTheme, setGridTheme] = useLocalStorage('gridTheme', deafaultGridThemeSettings);
  ...
  const onChangeMode = useCallback(
    (event) => {
      ...
      setGridTheme({...settings, themeMode })
      setSettings({ ...settings, themeMode });
    },
    [setSettings, settings]
  );
  ...
  // Grid Theme
  const onChangeGridMode = useCallback()
